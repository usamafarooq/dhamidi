...
<div id="page-wrapper">
    ...
    <div class="content">
        ...
        <form method="post" action="<?php echo base_url() ?>admin/portfolio_category/update" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $portfolio_category["id"] ?>">
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body"><div class="form-group row">
                                ...
                                <label for="example-text-input" class="col-sm-3 col-form-label">Name<span class="required">*</span></label>
                                        ...
                                        <input class="form-control" name="Name" type="text" value="<?php echo $portfolio_category["Name"] ?>" id="example-text-input" placeholder="" required=""></div>

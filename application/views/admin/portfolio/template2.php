...
<head>
    ...
    <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="<?php echo base_url('page_bulder/img/favicon.png') ?>">
                    ...
                    <div class="sidebar-nav">
                      ...
                      <span class="btn-group">
                        <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">Styles <span class="caret"></span></a>
                                    ...
                                    <div class="view"> <img alt="140x140" src="<?php echo base_url('page_bulder/img/a.jpg') ?>"> </div>
                                </div>
                                <div class="box box-element ui-draggable">
                                    <a href="#close" class="remove label label-important"><i class="icon-remove icon-white"></i>Remove</a> <span class="drag label"><i class="icon-move"></i>Drag</span>
                                ...
                                <div class="box box-element ui-draggable">
                                    ...
                                    <div class="view">
                                        <div class="hero-unit" contenteditable="true">
                                            <h1>Hello, world!</h1>
                                            <p>This is a template for a simple marketing or information website. It includes a large callout called the herop unit and three supporting pieaces of content. Use iot as starting point to create something more unique
                                            </p>
                                ...
                                <div class="box box-element ui-draggable">
                                    ...
                                    <div class="view">
                                        <ul class="thumbnails">
                                            <li class="span4">
                                                <div class="thumbnail">
                                                    <img alt="300x200" src="<?php echo base_url('page_bulder/img/people.jpg') ?>">
                                            ...
                                            <li class="span4">
                                                <div class="thumbnail">
                                                    <img alt="300x200" src="<?php echo base_url('page_bulder/img/city.jpg') ?>">
                                                    <div class="caption" contenteditable="true">
                                                        <h3>Thumbnail label</h3>
                                                        <p> Bacon ipsum dolor sit amet doner ham leberkas short loin hamburger, flank drumstick corned beef. Doner meatball venison bresaola biltong chicken. Turkey bacon shoulder strip steak spare ribs tri-tip. Rump ground round strip steak kielbasa short loin t-bone. Biltong capicola corned beef, ribeye chuck andouille sausage ham hock turkey spare ribs beef tail sirloin shank.</p>
                                                        <p><a class="btn btn-primary" href="#">Action</a> <a class="btn" href="#">Action</a></p>
                                            ...
                                            <li class="span4">
                                                <div class="thumbnail">
                                                    <img alt="300x200" src="<?php echo base_url('page_bulder/img/sports.jpg') ?>">
                                                    <div class="caption" contenteditable="true">
                                                        <h3>Thumbnail label</h3>
                                                        <p> Bacon ipsum dolor sit amet doner ham leberkas short loin hamburger, flank drumstick corned beef. Doner meatball venison bresaola biltong chicken. Turkey bacon shoulder strip steak spare ribs tri-tip. Rump ground round strip steak kielbasa short loin t-bone. Biltong capicola corned beef, ribeye chuck andouille sausage ham hock turkey spare ribs beef tail sirloin shank.</p>
                                                        <p><a class="btn btn-primary" href="#">Action</a> <a class="btn" href="#">Action</a></p>
                      ...
                      <span class="btn-group">
                        <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">Colors<span class="caret"></span></a>
                                ...
                                <div class="box box-element ui-draggable">
                                    ...
                                    <div class="view">
                                        <div class="media">
                                            <a href="#" class="pull-left"> <img src="<?php echo base_url('page_bulder/img/a_002.jpg" class="media-object"> </a>
                                        ...
                                        <div class="carousel slide" id="myCarousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <img alt="" src="<?php echo base_url('page_bulder/img/1.jpg') ?>">
                                                ...
                                                <div class="item">
                                                    <img alt="" src="<?php echo base_url('page_bulder/img/2.jpg') ?>">
                                                    <div class="carousel-caption" contenteditable="true">
                                                ...
                                                <div class="item">
                                                    <img alt="" src="<?php echo base_url('page_bulder/img/3.jpg') ?>">
                                                    <div class="carousel-caption" contenteditable="true">

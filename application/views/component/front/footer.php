            ...
            <div class="container">
                <div class="row equalize xs-equalize-auto">
                    ...
                    <div class="col-md-4 col-sm-2 col-xs-12 text-center display-table xs-margin-10px-bottom">
                        <div class="display-table-cell vertical-align-middle">
                            <a href="<?php echo base_url() ?>"><img class="footer-logo" src="<?php echo base_url() ?>front_assets/images/logo-white.png" data-at2x="images/logo-white@2x.png" alt="Pofo"></a>
                        </div>
                    </div>
                    <!-- end logo -->
                    <!-- start social media -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 widget sm-margin-30px-bottom">
                        ...
                        <ul class="latest-post position-relative top-3">
                            <li class="border-bottom border-color-medium-dark-gray">
                                <figure>
                                    <a href="blog-post-layout-01.html"><img src="<?php echo base_url() ?>front_assets/images/latest-blog2.jpg" alt=""></a>
                                </figure>
                            ...
                            <li class="border-bottom border-color-medium-dark-gray">
                                <figure>
                                    <a href="blog-post-layout-02.html"><img src="<?php echo base_url() ?>front_assets/images/latest-blog3.jpg" alt=""></a>
                                </figure>
                            ...
                            <li>
                                <figure>
                                    <a href="blog-post-layout-03.html"><img src="<?php echo base_url() ?>front_assets/images/latest-blog4.jpg" alt=""></a>
                                </figure>
